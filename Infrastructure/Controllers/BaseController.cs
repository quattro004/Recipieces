...
namespace Infrastructure.Controllers
{
    ...
    [ApiController]
    public abstract class BaseController<T> : ControllerBase where T : DataObject
    {
        ...
        public virtual async Task<IEnumerable<T>> List()
        {
            ...
            return await _dataService.List();
        }
        ...
        /// </summary>
        /// <param name="id"></param>
        /// <returns>A <see cref="DataObject" /> if one exists by the identifier.</returns>
        ...
        public virtual async Task<ActionResult<T>> GetData(string id)
        {
            ...
            var dataObject = await _dataService.GetData(id);
